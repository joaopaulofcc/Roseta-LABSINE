...
%#                                                                       #
%#    Script responsible to communicate with Grain (ROSETA) in FPGA.     #
%#                                                                       #
%#                                                                       #
%# STUDENT                                                               #
%#                                                                       #
...
%# File: grainFPGA.m                                                     #
%#                                                                       #
%# About: This file describe a script which handle with the grain in     #
...
%#                                                                       #
%#     IV: the 64 bits iv in hexadecimal format.                         #
%#                                                                       #
...
function grainFPGA(reset, Key, IV, w, h, d, output, baud, com)
