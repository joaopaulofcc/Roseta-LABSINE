...
%#                                                                       #
%#    Script responsible to communicate with MICKEY (ROSETA) in FPGA.    #
%#                                                                       #
%#                                                                       #
%# STUDENT                                                               #
%#                                                                       #
...
%# File: mickeyFPGA.m                                                    #
%#                                                                       #
%# About: This file describe a script which handle with the mickey in    #
...
function mickeyFPGA(reset, Key, IV, w, h, d, output, baud, com)
