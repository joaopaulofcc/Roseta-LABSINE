...
int main(int argc, char *argv[])
{
  ...
  u8 key[MAXKEYSIZEB]   = {atoi(argv[11]), atoi(argv[10]), atoi(argv[9]), atoi(argv[8]),  atoi(argv[7]), \
                           atoi(argv[6]),  atoi(argv[5]),  atoi(argv[4]), atoi(argv[3]),  atoi(argv[2])};

  u8 iv[MAXIVSIZEB]     = {atoi(argv[21]), atoi(argv[20]), atoi(argv[19]), atoi(argv[18]), atoi(argv[17]), \
                           atoi(argv[16]), atoi(argv[15]), atoi(argv[14]), atoi(argv[13]), atoi(argv[12])};
