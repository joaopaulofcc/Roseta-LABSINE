...
%#        images, the generator used is the Grain. This file contains    #
...
%#         is represented by a string of 16 hexadecimal digits. For IV   #
...
function toolGrain(w, h, color, qtd, Key, IV, output)
    ...
    system(['grain ' num2str((w*h*d*8*2*qtd)/32) ' ' Key ' ' IV ' > ' output]);
