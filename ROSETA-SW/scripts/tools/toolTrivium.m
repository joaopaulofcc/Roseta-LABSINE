...
%#        images, the generator used is the Trivium. This file contains  #
...
function toolTrivium(w, h, color, qtd, Key, IV, output)
    ...
    system(['trivium ' num2str((w*h*d*8*2*qtd)/32) ' ' Key ' ' IV ' > ' output]);
